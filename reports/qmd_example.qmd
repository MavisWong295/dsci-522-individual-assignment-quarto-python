...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse_pop width=90%}
...
We present the standard deviations in @tbl-std_horse.
...
Additionally, note that in @tbl-std_horse we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pop.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse_std width=60%}

In @fig-horse_std we zoom in and look at the province of `{python} horses_sd_table['Province'][0]`, which had the largest spread of values in terms of standard deviation.
